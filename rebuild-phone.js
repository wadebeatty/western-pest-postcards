...
const TRUCK = '/Users/max/.openclaw/westernmarketing/4.1 Pictures/2025 Pictures/Vehicle/Truck with Zion in background.jpg';
const SHIELD = '/Users/max/.openclaw/westernmarketing/0.1 Logo Externally Shared /Shared Externally/W Shield -signature.png';
...
const PEOPLE = [
  { name: 'John & Sarah Miller',   addr: '123 Red Rock Dr',       city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Michael Rodriguez',     addr: '456 Desert View Ln',    city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'David Chen',            addr: '789 Pine Valley Rd',    city: 'Hurricane',  st: 'UT', zip: '84737' },
  { name: 'Lisa Thompson',         addr: '321 Sunset Blvd',       city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Robert & Maria Garcia', addr: '654 Canyon Crest Dr',   city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'James Wilson',          addr: '987 Tuacahn Dr',        city: 'St George',  st: 'UT', zip: '84738' },
  { name: 'Patricia Lee',          addr: '147 Bloomington Dr',    city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Thomas & Emily Clark',  addr: '258 Red Hills Pkwy',    city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Richard Brown',         addr: '369 Dixie Downs Rd',    city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Susan Martinez',        addr: '741 Sand Hollow Rd',    city: 'Hurricane',  st: 'UT', zip: '84737' },
  { name: 'William Taylor',        addr: '852 Kayenta Dr',        city: 'Ivins',      st: 'UT', zip: '84738' },
  { name: 'Jennifer White',        addr: '963 Ancestor Square',   city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Charles Harris',        addr: '159 Red Cliff Dr',      city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Elizabeth Martin',      addr: '753 Snow Canyon Pkwy',  city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Joseph Anderson',       addr: '951 Green Valley Dr',   city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Margaret Thompson',     addr: '357 Black Ridge Dr',    city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'Daniel Moore',          addr: '486 Entrada Dr',        city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Karen Jackson',         addr: '579 Middleton Dr',      city: 'Hurricane',  st: 'UT', zip: '84737' },
  { name: 'Steven Lewis',          addr: '682 Red Mountain Dr',   city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Barbara Hall',          addr: '793 Sun River Dr',      city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Paul Walker',           addr: '814 Tonaquint Dr',      city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Nancy Young',           addr: '925 Little Valley Rd',  city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'Mark King',             addr: '136 Green Spring Dr',   city: 'Hurricane',  st: 'UT', zip: '84737' },
  { name: 'Brian & Amy Johnson',   addr: '247 Red Mountain Dr',   city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Christopher Davis',     addr: '368 Sunbrook Dr',       city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Jessica Wilson',        addr: '479 Green Valley Dr',   city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Kevin & Samantha Brown',addr: '582 Bloomington Hills Dr',city:'St George', st: 'UT', zip: '84790' },
  { name: 'Matthew Taylor',        addr: '693 Dixie Downs Rd',    city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Rachel Martinez',       addr: '794 Tuacahn Dr',        city: 'Ivins',      st: 'UT', zip: '84738' },
  { name: 'Andrew Clark',          addr: '815 Red Hills Pkwy',    city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Nicole Harris',         addr: '926 Snow Canyon Dr',    city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Timothy Lee',           addr: '137 Little Valley Rd',  city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'Stephanie Walker',      addr: '248 Sand Hollow Rd',    city: 'Hurricane',  st: 'UT', zip: '84737' },
  { name: 'Jonathan Young',        addr: '359 Middleton Dr',      city: 'Hurricane',  st: 'UT', zip: '84737' },
  { name: 'Amanda King',           addr: '461 Entrada Dr',        city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'David & Sarah White',   addr: '572 Sun River Dr',      city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Robert Thompson',       addr: '683 Tonaquint Dr',      city: 'St George',  st: 'UT', zip: '84770' },
  { name: 'Michelle Garcia',       addr: '794 Red Cliff Dr',      city: 'St George',  st: 'UT', zip: '84790' },
  { name: 'Daniel Rodriguez',      addr: '815 Canyon Crest Dr',   city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'Jennifer Miller',       addr: '926 Pine Valley Rd',    city: 'Hurricane',  st: 'UT', zip: '84737' },
  { name: 'William Davis',         addr: '137 Desert View Ln',    city: 'St George',  st: 'UT', zip: '84790' },
];
...
async function buildOne(p,i){
  ...
  await sharp(tmpF).resize(3300,1800,{fit:'fill'}).jpeg({quality:95}).toFile(ff);
  ...
  await sharp(tmpB).resize(3300,1800,{fit:'fill'}).jpeg({quality:95}).toFile(bf);
