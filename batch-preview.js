...
const FIELD_TECHS = ['scott'];

const PEOPLE = [
  { name: 'JENNY PETERSON', addr: '611 Quail Ridge Dr', city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'JEFFREY PAWLOWSKI', addr: '2014 N Vista Springs Dr', city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'BRIAN JENSEN', addr: '1930 N Outlook Dr', city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'BRENDA PULLEY', addr: '2032 N Vista Springs Dr', city: 'Washington', st: 'UT', zip: '84780' },
  { name: 'ROBERT LEAVITT', addr: '1050 W Red Hills Pkwy Unit 58', city: 'Washington', st: 'UT', zip: '84780' },
];
